...
public class EmployeeInfo extends EmployeeAbstract implements Employee {
    ...
    private static final String Vison = "We Belive in Information";
     ...
     * go to EmployeeFortune class to apply all the fields and attributes.
     *
...
//employeeName() will return employee name
    ...
    //assign Departments() - will assign employees to departments
    public void assignDepartments(String departmentName) {
    ...
    public void createCompany() {
        companyName = "NOVA";
        int foundedyear;
        System.out.println(companyName+ " " + founderName + " " + address + " ");
    }

    public void createCompany(String vison) {
    ...
    public static double calculateEmployeeBonus(double salary, int performance) {
        ...
        if (performance == 8) {
            ...
            yearlyBonus = salary * .06 * 12;
        } else if (performance == 2) {
            yearlyBonus = salary * .04 * 12;
        } else if (performance == 0) {
            yearlyBonus = 0;
            System.out.println("Please ready to depart");
        }
        return yearlyBonus;
    ...
    public static int calculateEmployeePension(int i, int i1) {
        int total = 0;
        Scanner sc = new Scanner(System.in);
        System.out.println("Please enter start date in format (example: May,2015): ");
        String joiningDate = sc.nextLine();
    ...
    public void assignDepartment(String it) {
    ...
    private static class DateConversion {
        ...
        public DateConversion(EmployeeMonths months) {
        }
        ...
        public static int whichMonth(String givenMonth) {
            EmployeeMonths months = EmployeeMonths.valueOf(givenMonth);
            int date = 0;
            switch (months) {
                case January:
                    date = 1;
